...
public class Producto1Service {
    ...
    public Optional<Producto1> getByNombre(String producto1){
    ...
    public boolean existsByNombre(String producto1){
        return Producto1Repository.existsByProductoNombre(producto1);
    }
}